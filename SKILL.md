...
- 总览页路径：`assets/gallery/style-gallery.html`
- 开源入口页：`README.md`
...
- 当用户仍处于“先看看有哪些风格”“先帮我挑方向”的阶段，优先提醒可打开 `assets/gallery/style-gallery.html`，不要一上来就把注意力带到脚本和参数。
...
- 本地总览页：`assets/gallery/style-gallery.html`
- 开源入口页：`README.md`
